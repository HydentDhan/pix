...
public enum RaidDifficulty {
   EASY(1.0F, 0.75F), NORMAL(1.0F, 1.0F), HARD(1.0F, 1.5F), NIGHTMARE(1.0F, 2.0F);
   ...
   public float getPlayerDamageMultiplier() { return this.playerDamageMultiplier; }
   public float getBossDamageMultiplier() { return this.bossDamageMultiplier; }
}