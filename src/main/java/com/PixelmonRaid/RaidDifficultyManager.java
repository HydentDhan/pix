...
public class RaidDifficultyManager {
   private static RaidDifficultyManager.Difficulty current;

   public static void setDifficulty(RaidDifficultyManager.Difficulty difficulty) {
      current = difficulty;
   }

   public static RaidDifficultyManager.Difficulty getDifficulty() {
      return current;
   }

   static {
      current = RaidDifficultyManager.Difficulty.NORMAL;
   }
