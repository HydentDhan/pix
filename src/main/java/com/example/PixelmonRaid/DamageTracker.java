...
public class DamageTracker {
    ...
    public void addDamage(UUID player, int damage) {
        ...
        // --- SAFE BATTLEPASS INTEGRATION (Soft Dependency) ---
        // This will strictly prevent crashes if the Battlepass mod is missing.
        try {
            if (net.minecraftforge.fml.ModList.get().isLoaded("pixelmonbattlepass")) {
                ...
                if (server != null) {
                    ...
                    if (playerEntity != null) {
                        // Use Reflection to call the method without a hard import
            ...
            // If anything goes wrong or the mod isn't there, it safely ignores it.
        }
    }
